...
open Example /* (A) Use this file as an example for adding a new form to ExplainThis. * You should be able to copy-paste this file and modify it to add a new form */;
